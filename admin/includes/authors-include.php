...
<script type="text/javascript">
  ...
  <div class="container">
    ...
    <div class="row"> <div class="col-lg-12 text-lett"> <h2 class="mt-5">Authors</h2> </div> </div>
		...
		<?php
		  ...
		  foreach ($rowsAuthors as $row) {
			...
			if ( $row['enabled'] == "1") {
			  ...
			  $enabled = "<img src='../assets/img/activo.png'  height=20px width=20px>";

			} else {

			  $enabled = "<img src='../assets/img/no_activo.png' height=20px width=20px>";
			...
			echo '
			  ...
			  <td><a href="#" OnClick="deleteAuthor('.$row['authorId'].')"><img src="../assets/img/delete_2.png"height=20px width=20px></a></td>
			  </tr>
			'
			;  
